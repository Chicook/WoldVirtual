...
contract MyToken is IBEP20 {
    ...
    uint256 public totalSupply = 100000000000000000000000000; //100 millones de tokens
    uint8 public decimals = 18;
    address public liquidityAddress = address(0x123); //direccion de la cuenta de contrato inteligente que mantendra la liquidez
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
        ...
        _balances[liquidityAddress] += amount - transferAmount; //agregar las comisiones al saldo de la direccion de liquidez
